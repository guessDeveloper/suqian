<template>
 ...
 <p>大多数企业家虽然看中诉讼的结果，但却对诉讼本身没有足够的信心。始终认为诉讼充满了太多无法把控的不确定性。然而，这种不确定性仍然可以通过有效的方法和技术手段来降低，从而提高企业的诉讼取胜概率。并且，这套方法和技术手段是应该让企业在诉前知晓，并且基于此结论做出诉讼决策。因此，我们决定用匠人的精神，把服务聚焦在诉前每一个专业的细节上。于是，便有了“Pre Suit诉前”的今天。</p>
            </div>
